...
from test_framework.test_framework import THMTestFramework, SkipTest
from test_framework.util import (assert_equal,
                                 bytes_to_hex_str,
                                 hash256,
                                )

class ZMQTest (THMTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that thm has been built with ZMQ enabled
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("thmd has not been built with zmq enabled.")
