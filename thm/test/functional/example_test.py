...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the THMTestFramework
    pass

class ExampleTest(THMTestFramework):
    # Each functional test is a subclass of the THMTestFramework class.
    ...
    def custom_method(self):
        ...
        THMTestFramework class so other tests can use it."""
