...
# TestNode: A peer we use to send messages to thmd, and store responses.
...
class CompactBlocksTest(THMTestFramework):
    ...
    # This test actually causes thmd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that thmd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for thmd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # thmd will not send blocktxn responses for blocks whose height is
