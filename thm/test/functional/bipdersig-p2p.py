...
class BIP66Test(THMTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # thmd is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and thmd produces more specific reject
            # reasons.
