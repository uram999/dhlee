...
unlocked to sign the THM-Qt.app bundle.
...
allowing somebody to distribute a THM-Qt.app or thm-qt-setup.exe with a valid
...
that the thm-qt.exe file inside the installer had not been tampered with.
