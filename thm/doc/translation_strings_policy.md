...
This document provides guidelines for internationalization of the THM Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `thm_en.ts` remains unchanged.
