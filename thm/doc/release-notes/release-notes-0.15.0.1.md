THM Core version *0.15.0.1* is now available from:

  <https://thm.org/bin/thm-core-0.15.0.1/>

and

  <https://thmcore.org/bin/thm-core-0.15.0.1/>
...
installer (on Windows) or just copy over `/Applications/THM-Qt` (on Mac)
or `thmd`/`thm-qt` (on Linux).
