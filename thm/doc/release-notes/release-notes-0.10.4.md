THM Core version 0.10.4 is now available from:

  <https://thm.org/bin/thm-core-0.10.4/>
...
- #6953 `43c2789` Split thm-tx into its own package
- #6953 `dfe0d4d` Include thm-tx binary on Debian/Ubuntu
