THM version 0.5.4 is now available for download at:
http://sourceforge.net/projects/thm/files/THM/thm-0.5.4/
...
http://gitorious.org/thm/thmd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix THM-Qt notifications under Growl 1.3.
Increase required age of THM-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxTHM properly when installing THM-Qt over it. (Windows)
