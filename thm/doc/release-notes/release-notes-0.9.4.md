THM Core version 0.9.4 is now available from:

  https://thm.org/bin/0.9.4/
...
this update is incompatible with the THM system and could lead to consensus
forks.

THM Core released binaries from https://thm.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~thm/+archive/ubuntu/thm
- A third-party or self-compiled THM Core

upgrade to THM Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
