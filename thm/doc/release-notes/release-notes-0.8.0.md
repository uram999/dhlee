THM-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/thm/files/THM/thm-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the THM
...
New/changed settings (command-line or thm.conf file)
--------------------------------------------------------
