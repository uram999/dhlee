THM Core version 0.13.2 is now available from:

  <https://thm.org/bin/thm-core-0.13.2/>
...
- #8908 `4a974b2` Update thm-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow thm-tx to create v2 transactions (thmdrak)
