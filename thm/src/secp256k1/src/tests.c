...
void test_add_neg_y_diff_x(void) {
     ...
     * root of https://github.com/thm-core/secp256k1/issues/257
...
static void random_ber_signature(unsigned char *sig, size_t *len, int* certainly_der, int* certainly_not_der) {
    ...
    *certainly_not_der = 0;
    ...
    for (n = 0; n < 2; n++) {
        ...
        /* The top byte of the number (after the potential hathmoded 16 0xFF characters for "high" 32 bytes numbers) */
