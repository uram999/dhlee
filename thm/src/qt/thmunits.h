...
#ifndef THM_QT_THMUNITS_H
#define THM_QT_THMUNITS_H
...
/** THM unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class THMUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit THMUnits(QObject *parent);

    /** THM units.
      @note Source: https://en.thm.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        THM,
...
typedef THMUnits::Unit THMUnit;

#endif // THM_QT_THMUNITS_H
