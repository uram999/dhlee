...
#ifndef THM_TEST_SCRIPTNUM10_H
#define THM_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from THM Core 0.10.0, for cross-comparison.
 */
public:
